...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { TX }]; #IO_L20N_T3_34 Sch=BTN0
...
##I2C pins
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L3N_T0_DQS_34 Sch=JE7
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { SCL }]; #IO_L6N_T0_VREF_34 Sch=JD2_N
