...
add_force {/fifo/BTN_PUSH}  -radix bin {0 0ns}
...
############################ PUSH
# PUSH 5
add_force {/fifo_test/DIN}       -radix hex {5 0ns}
add_force {/fifo_test/BTN_PUSH}      -radix bin {1 0ns}
run 8ns
add_force {/fifo_test/BTN_PUSH}      -radix bin {0 0ns}
run 30ns
# PUSH 8
add_force {/fifo/DIN}       -radix hex {8 0ns}
add_force {/fifo/BTN_PUSH}      -radix bin {1 0ns}
run 8ns
add_force {/fifo/BTN_PUSH}      -radix bin {0 0ns}
run 30ns
# PUSH B
...
############################ POP
# POP
add_force {/fifo/BTN_POP}      -radix bin {1 0ns}
run 8ns
add_force {/fifo/BTN_POP}      -radix bin {0 0ns}
run 30ns
# POP
add_force {/fifo/BTN_POP}      -radix bin {1 0ns}
run 8ns
