...
## Create Date:     02/2020
## Description:     XDC modified file for zybo board
##
###############################
...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { BTN_ADDR }]; #IO_L20N_T3_34 Sch=BTN0
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { BTN_WRITE }]; #IO_L24N_T3_34 Sch=BTN1
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { BTN_READ }]; #IO_L18P_T2_34 Sch=BTN2
...
##DISPLAY 7 SEGMENTS
# ----- ANODES -----
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { AN[7] }]; #IO_L21N_T3_DQS_34 Sch=JD4_N
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { AN[6] }]; #IO_25_35 Sch=JE3
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { AN[5] }]; #IO_L4P_T0_34 Sch=JE1
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { AN[4] }]; #IO_L20P_T3_34 Sch=JE9
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { AN[3] }]; #IO_L3N_T0_DQS_34 Sch=JE7
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { AN[2] }]; #IO_L6N_T0_VREF_34 Sch=JD2_N
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { AN[1] }]; #IO_L7N_T1_34 Sch=JE10
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { AN[0] }]; #IO_L18N_T2_34 Sch=JE2
# ----- CATHODES -----
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { CAT[0] }]; #IO_L21P_T3_DQS_34 Sch=JD4_P
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { CAT[1] }]; #IO_L6P_T0_34 Sch=JD2_P
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { CAT[2] }]; #IO_L19P_T3_35 Sch=JE4
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { CAT[3] }]; #IO_L9N_T1_DQS_34 Sch=JE8
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { PWM }]; #IO_L5P_T0_34 Sch=JD1_P       -- Used for PWM
